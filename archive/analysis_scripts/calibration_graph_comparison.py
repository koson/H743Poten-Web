...
Displays comparison graphs of STM32 before/after calibration with PalmSens reference
"""
...
class CalibrationGraphComparison:
    ...
    def plot_comparison(self, stm32_id, palmsens_id):
        ...
        try:
            ...
            ax1.set_title('🔴 STM32 Before Calibration (Raw Data)', fontweight='bold')
            ...
            ax2.set_title('🟢 STM32 After Calibration', fontweight='bold')
...
def main():
    """Main function"""
    print("🚀 Starting Calibration Graph Comparison")
    ...
    print("\n🎯 Showing sample comparison (STM32 ID: 67 vs PalmSens ID: 77)")
